...
import requests
import argparse
#https://github.com/nondanee/weiboPicDownloader/blob/dev/README-CN.md
try:
    reload(sys)
...
user_input = input('请输入微博uid:')#1744395855
users = [user_input]
# video_input = input('是否下载视频:')
...
#         quit('do it youself :)')
# else:
#     base = os.path.join(os.path.dirname(__file__), 'pics')
#     if not os.path.exists(base): make_dir(base)
base = os.path.join(os.getcwd(), 'pics')

...
#https://github.com/yumendy/nine_picture/blob/master/main.py 将一张图片切割为九张小图片
#https://github.com/archaeondlg/Image-wechat/blob/master/img-wechat.py
#python main.py C image_path # 居中裁剪

#python main.py F test.jpg # 白色填充

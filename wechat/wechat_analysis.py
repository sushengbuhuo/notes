...
# 导出设置https://github.com/Light-City/weixinAnalysis/blob/master/analysis.py
...
def plot_location(friends):
    ## 通过循环实现将所有好友所在省份加到列表中，并且去除空字符https://github.com/Light-City/weixinAnalysis/blob/master/analysis.py
    for friend in friends[1:]:

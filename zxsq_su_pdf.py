...
GROUP_ID = '141281112142'                                  # 知识星球中的小组ID 141281112142
PDF_FILE_NAME = '知识星球_工具大搜罗.pdf'                               # 生成PDF文件的名字
...
Connection:keep-alive
Cookie:sensorsdata2015jssdkcross=; zsxq_access_token=BA; abtest_env=product; UM_distinctid=165d-1fa400-16cfc3fe068966
DNT:1
Host:api.zsxq.com
Origin:https://wx.zsxq.com
Referer:https://wx.zsxq.com/dweb2/index/group/141281112142
...
X-Request-Id:8728386e2-8ea0-aad2-4cb4-bdf0eb82ea0
X-Signature:14d46fed62efe4c841c398de8de4f2b071b3bc93
X-Timestamp:1567600483
X-Version:1.10.17
    """
    ...
    with open('temp.json', encoding='utf-8') as f, open('contents.txt', 'a+', encoding='utf-8') as f2:
...
def wordimage(content):
    ...
    cleaned_comments = ''.join(jieba.cut(comments))
    ...
    plt.axis("off")
    plt.show()
    wordcloud.to_file('zsxq_susheng.jpg')

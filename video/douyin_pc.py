...
import os
import requests
#https://www.52pojie.cn/thread-1685010-1-1.html
...
if __name__ == '__main__':
    url = input('请输入作者主页链接：')  # 输入作者主页链接 https://www.douyin.com/user/MS4wLjABAAAAU7ibxriLF-GSBF5QKa1Op9hxcMAPVmzmXwXqqvMfrhs
    headers = {

...
#https://github.com/JustDoPython/python-examples/blob/master/moumoubaimifan/bilibili_crawler/bilibili_crawl.py
class bilibili_crawl:
    ...
    def download_video(self, video):
        ...
        url = video['url']
        filename = title + '.mp4'
        headers = {'Origin':'https://www.bilibili.com','Referer':self.url,'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36'}
        with open('bilibili_down.mp4','wb') as f :
...
if __name__ == '__main__':
        bc = bilibili_crawl('BV17K4y1x7gs')

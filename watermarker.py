...
def add_mark(imagePath, mark, args):
    '''
    添加水印，然后保存图片https://github.com/2Dou/watermarker/blob/master/marker.py https://zhuanlan.zhihu.com/p/101897902
    https://github.com/Brucepk/download-no-copyright-image/blob/master/text2photo.py
    美图秀秀在线版：http://xiuxiu.web.meitu.com 所以今天用到的工具是batchinpaint 水印管家 
    既然提到水印就在补充几个在线加水印的工具
水水的证件：https://www.simpletool.cn
压缩图：https://www.yasuotu.com/shuiyin
改图宝：http://www.gaitubao.com/shuiyin
https://zhuanlan.zhihu.com/p/74287170 https://www.lanzoux.com/iBfwoeni5gb
    '''

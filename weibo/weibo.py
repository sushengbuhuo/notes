...
class Weibo(object):
    ...
    def get_json(self, params):
        ...
        r = requests.get(url, params=params, headers=self.headers, verify=False);print('请求链接',r.url)
    ...
    def parse_weibo(self, weibo_info):
        ...
        weibo["bid"] = f'https://weibo.com/{weibo["user_id"]}/{weibo_info["bid"]}'
    ...
    def get_one_page(self, page):
        ...
        try:
            ...
            if js["ok"]:
                weibos = js["data"]["cards"];print(page)
                if self.query:
                    weibos = weibos[0]["card_group"]
                elif 'card_group' in weibos[0]:#改动
                    # weibos.extend(weibos[0]["card_group"])
                    weibos = weibos[0]["card_group"] + weibos

...
#https://github.com/nlpjoe/weiboSpider
import codecs
import copy
import csv
import json
...
class Weibo(object):
    ...
    def get_json(self, params):
        ...
        r = requests.get(url, params=params, cookies=self.cookie,verify=False)
        return r.json()
    ...
    def get_long_weibo(self, id):
        ...
        for i in range(5):
            ...
            html = requests.get(url, cookies=self.cookie,verify=False).text

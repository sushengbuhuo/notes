...
wc = WordCloud(font_path=r'C:\Windows\Fonts\simhei.ttf',#EDA/KaiTi.ttf
                max_words=2000,
                width=1920,
                height=1080,
...
avg_M_df.index.name = f'{bozhu} 发微博时间'
plt.figure(figsize=(15, 10))
plt.title(f"{bozhu} 单月转评赞总数")

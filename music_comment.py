...
'''
原创作者：pk哥 https://github.com/Brucepk/Kris-noodles/blob/master/music163-noodles.py
Date：2019/4/20
原创首发于公众号：Python知识圈，欢迎关注查看更多精彩实战项目
爬取网易云歌单下载https://github.com/unlimitbladeworks/python-tools/blob/cccd8946c8ede31c698ed2de0469b1e9ef547b3e/spider/crawl_wymusic.py
'''
...
hot_url = 'http://music.163.com/api/v1/resource/comments/R_SO_4_299936?limit=20&offset=0'
...
word = ",".join(cut)
coloring = np.array(Image.open("wangfei.jpg"))  # 电脑中自定义词云的图片
my_wordcloud = WordCloud(background_color="white", max_words=3000, max_font_size=200,
                         mask=coloring, random_state=100, font_path='C:\Windows\Fonts\simhei.ttf',
...
for j in range(0, 2001, 20):
    all_url = 'http://music.163.com/api/v1/resource/comments/R_SO_4_299936?limit=20&offset={}'.format(j)
    for k in range(0, 20):

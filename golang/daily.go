...
// 获取Bing当日壁纸https://github.com/smloli/todayNewsSpider/blob/main/todayNewsSpider-pushPlus/main.go
...
func readConfig() string {
	var con Config
	path := filepath.Dir(os.Args[0]) + filepath.FromSlash("/") + "config.json";fmt.Println(path)

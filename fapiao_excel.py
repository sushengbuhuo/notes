        ...
        for filename in os.listdir(pdf_folder):
            if filename.lower().endswith(".pdf"):
                ...
                with pdfplumber.open(pdf_path) as pdf:
                    ...
                    pattern_invoice_date = re.compile(r"[开票|订单日期：\x20?(20\d{2})\x20?年\x20?(\d{2})\x20?月\x20?(\d{2})\x20?日")
                    ...
                    invoice_stuff = re.compile(r"(\*[\u4e00-\u9fa5+\*[\s\S*)((合\x20?计\x20)?&#165;(\d+\.\d{2}))").findall(text)
